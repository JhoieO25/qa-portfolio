export default function Contact() {
  return (
    <section id="contact" className="py-20 bg-neutral-900 text-gray-100 text-center px-6">
      <h2 className="text-3xl font-bold mb-6">Let’s Work Together</h2>
      <p className="text-gray-400 max-w-2xl mx-auto mb-8">
        Open to QA/Software Testing and Tech Consulting roles with a Quality-driven Team.
